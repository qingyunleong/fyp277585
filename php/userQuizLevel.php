...
if (isset($_GET['categorylevel'])) {
    $category_level = $_GET['categorylevel'];

    $sqlcategorylevel = "SELECT * FROM tbl_category WHERE category_level = '$category_level'";
    $stmt = $conn->prepare($sqlcategorylevel);
    $stmt->execute();
...
<body>
    ...
    <div class="main">
        <div class="feeds">
            <a href="userQuiz.php"><span class="edit fa fa-angle-left"></span></a>

            <div class="feed">
                Step <?php echo $categorylevel ?>: <?php echo $categoryname ?>
            </div>

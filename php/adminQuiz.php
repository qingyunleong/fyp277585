...
$sqlcategoty = "SELECT * FROM tbl_category GROUP BY category_level ORDER BY category_level";
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                echo "<table class='content-table'><thead><tr><th>No</th><th>Information Level</th><th>Operations</th></tr></thead>";
                ...
                foreach ($rows as $category) {
                    ...
                    echo "<tbody><tr><td>$i</td><td>Step $categorylevel : $categoryname</td>
